...
namespace Chess.Entities.ChessEntities.Pecas
{
    class Peao : Peca
    {
        ...
        public Peao(Tabuleiro tabuleiro, Cor cor, PartidaDeXadrez partida, Texture2D spriteSheet, Atlas atlas, float textureScaleRatio) : base(cor, tabuleiro, spriteSheet, atlas, textureScaleRatio)
        {
            this.partida = partida;
            textureName = "pawn" + this.Cor.Suffix();
            updateSpriteInfo();
        }
